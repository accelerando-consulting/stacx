...
#include "stacx/leaf_pinextender_mpr121.h"
...
const char *input_names = "CANCEL,SEVEN,FOUR,ONE,TWO,FIVE,ZERO,EIGHT,THREE,SIX,NINE,OK";
...
#endif
  new PinExtenderMPR121Leaf("inputs", 0x5a, input_names),
